...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { description: @grade.description, grade: @grade.grade } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { description: @grade.description, grade: @grade.grade } }
